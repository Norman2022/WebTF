...
public class AutomationPracticeConstants {
    ...
    public static final String DASHBOARD_XPATH = "xpath://a[text()='Dashboard']";
    public static final String ACCOUNT_DETAILS_XPATH = "xpath://a[text()='Account Details']";
